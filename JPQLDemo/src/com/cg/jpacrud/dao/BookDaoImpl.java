...
public class BookDaoImpl implements BookDao {
	...
	@Override
	public Book getBookById(int id) { //seen
	...
	@Override
	public List<Book> getBookByTitle(String title) { //seen
	...
	@Override
	public Long getBookCount() { //seen
		String qStr = "SELECT COUNT(book) FROM Book book";
	...
	@Override
	public List<Book> getAuthorBooks(String author) { //seen
	...
	@Override
	public List<Book> getAllBooks() { //seen
	...
	@Override
	public List<Book> getBooksInPriceRange(double low,double high) { //seen 
